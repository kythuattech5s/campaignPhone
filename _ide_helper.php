 ...
 */
     ...
     */ 
        ...
        {            //Method inherited from \Illuminate\Translation\Translator         
                        /** @var \vanhenry\manager\translator\HTranslator $instance */
        ...
        public static function macro($name, $macro)
        {            //Method inherited from \Illuminate\Translation\Translator         
                        \vanhenry\manager\translator\HTranslator::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {            //Method inherited from \Illuminate\Translation\Translator         
                        \vanhenry\manager\translator\HTranslator::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {            //Method inherited from \Illuminate\Translation\Translator         
                        return \vanhenry\manager\translator\HTranslator::hasMacro($name);
        }
                    /**
         * Flush the existing macros.
         *
        ...
        public static function flushMacros()
        {            //Method inherited from \Illuminate\Translation\Translator         
                        \vanhenry\manager\translator\HTranslator::flushMacros();
        }
...
namespace  { 
            ...
            class Support extends \App\Helpers\Support {}
            class VRoute extends \App\Helpers\VRoute {}

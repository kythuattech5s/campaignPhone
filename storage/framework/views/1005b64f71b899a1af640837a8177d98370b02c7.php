...
<head>
    ...
    <script type="text/javascript">
        var globalBaseUrl = "<?php echo e(asset('/') . $admincp); ?>";
        var _baseurl = "<?php echo e(asset('/')); ?>";
        var csrftokenname = '_token';
        var csrftokenvalue = '<?php echo e(csrf_token()); ?>';
...
<body>
    <div id="media-manage" class="media-manage">
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="media-view">
                        <?php if($trash == 0): ?>
                            <a class="viewtrash" href="<?php echo e($admincp); ?>/media/trash">Thùng
                                rác</a>
                        <?php else: ?>
                            <a class="viewtrash" href="<?php echo e($admincp); ?>/media/view">Thư mục
                                gốc</a>
                        <?php endif; ?>
        ...
        <div class="media-content container-fluid" style="overflow:hidden">
            <div class="row col-mar-5">
                <?php echo $__env->make('vh::media.media-manager', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
        <div
    ...
    <?php echo $__env->make('vh::media.newfolder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('vh::media.modalupload', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</body>

</html>
<?php /**PATH H:\laragon\www\laravel-tech5s\packages\vanhenry\manager\src/views/media/index.blade.php ENDPATH**/ ?>